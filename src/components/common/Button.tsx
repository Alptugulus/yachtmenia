...
const variants: Record<Variant, string> = {
  primary:
    'bg-white text-brand shadow-[0_2px_10px_-4px_rgb(0_0_50/0.18),0_1px_0_rgb(255_255_255/0.85)_inset] ring-1 ring-brand/[0.12] hover:bg-gold-hover hover:shadow-card focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand',
  secondary:
    'border border-brand/90 bg-white/60 text-brand shadow-[0_1px_0_rgb(255_255_255/0.9)_inset] backdrop-blur-sm hover:bg-brand/[0.08] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand',
  ghost:
